...
export default function HomePage() {
  return (
    <div className="bg-warmWhite">
      ...
      <section className="py-20 bg-cream/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-darkBrown mb-4">
      ...
      <section className="py-20 bg-warmWhite">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-deepBrown/70">Testimoni dari siswa dan orang tua</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gold to-darkBrown">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link
            href="/kontak"
            className="inline-flex items-center gap-2 bg-white text-darkBrown px-8 py-4 rounded-lg font-semibold hover:bg-cream transition-colors"
          >
            Daftar Sekarang
