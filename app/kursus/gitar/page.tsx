        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-cream rounded-xl p-6 sm:p-8 mb-8">
            ...
            <p className="text-deepBrown/80 leading-relaxed mb-4">
              Les gitar akustik dan elektrik untuk pemula hingga mahir. Gitar adalah salah satu instrumen paling populer dan fleksibel. Di Faeyza Music, kamu akan belajar dari dasar hingga bisa memainkan lagu favoritmu.
            </p>
            ...
            <ul className="space-y-2 text-deepBrown/80">
              <li className="flex items-center gap-2">• Dasar-dasar gitar (chord, strumming)</li>
              <li className="flex items-center gap-2">• Teknik fingerstyle</li>
              <li className="flex items-center gap-2">• Membaca tablatur dan chord chart</li>
              <li className="flex items-center gap-2">• Latihan lagu berbagai genre</li>
            </ul>
          </div>
          ...
          <div className="mb-8">
            ...
            <Gallery images={gitarImages} alt="Siswa Gitar" />
          </div>
          ...
          <div className="text-center">
            <h3 className="font-serif text-lg sm:text-xl font-bold text-darkBrown mb-4">Tertarik dengan Kursus Gitar?</h3>
