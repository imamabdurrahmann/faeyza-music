...
export const metadata: Metadata = {
  title: "Kursus Vocal - Faeyza Music Manna",
  description: "Les vokal private one-on-one di Faeyza Music Manna. Belajar teknik vokal dan ekspresi musik dengan pengajar berpengalaman.",
};
