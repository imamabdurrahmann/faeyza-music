...
export const metadata: Metadata = {
  title: "Kursus Biola - Faeyza Music Manna",
  description: "Les biola private one-on-one di Faeyza Music Manna. Belajar biola klasik dengan pengajar berpengalaman.",
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-cream rounded-xl p-6 sm:p-8 mb-8">
            ...
            <ul className="space-y-2 text-deepBrown/80">
              ...
              <li className="flex items-center gap-2">• Memainkan not dan skala</li>
              <li className="flex items-center gap-2">• Latihan repertoar klasik</li>
            </ul>
          </div>
