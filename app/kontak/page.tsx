...
export default function KontakPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/6281368107686?text=${encodeURIComponent(waMessage)}`, "_blank");
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <a href="https://wa.me/6281368107686" target="_blank" rel="noopener noreferrer"
              ...
              <p className="text-white/80">0813-6810-7686</p>
            </a>
            ...
            <a href="https://www.facebook.com/zulhan.tendy" target="_blank" rel="noopener noreferrer"
              ...
              <p className="text-white/80">zulhan.tendy</p>
            </a>
          </div>
        </div>
      </section>
